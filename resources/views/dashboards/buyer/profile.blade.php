              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  <div class="text-center">
                    <img class="profile-user-img img-fluid img-circle buyer_picture" src="{{ Auth::user()->picture }}" alt="User profile picture">
                  </div>
  
                  <h3 class="profile-username text-center buyer_name">{{Auth::user()->name}}</h3>

                  <p class="profile-email text-center buyer_email">{{Auth::user()->email}}</p>
                ...
                <div class="card-body">
                  <div class="tab-content">
                    <div class="active tab-pane" id="personal_info">
                      <form class="form-horizontal" method="POST" action="{{ route('buyerUpdateInfo') }}" id="BuyerInfoForm">
                    ...
                    <div class="tab-pane" id="change_password">
                        <form class="form-horizontal" action="{{ route('buyerChangePassword') }}" method="POST" id="changePasswordBuyerForm">
                          <div class="form-group row">
