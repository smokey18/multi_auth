            ...
            <div class="col-lg-10">
                ...
                <div class="card wish-list mb-3">
                    <div class="card-body">
                        ...
                        <h5 class="mb-4">Cart: {{ $cart->count('product_id') }}</h5>

                        @foreach ($cart as $cartItem)
                        <div class="cart-id-{{ $cartItem->id }}">
                            <div class="row mb-4">
                                ...
                                <div class="col-md-7 col-lg-9 col-xl-9">
                                    <div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <a cart-id="{{ $cartItem->id }}"
                                                    class="btn btn-warning text-uppercase mr-2 btn-cart-remove"
                                                    style="font-size: 10px">
                                                    <i class="fas fa-trash-alt mr-1"></i> Remove </a>
                                                <a href="#!" type="button" class="btn btn-primary text-uppercase"
                                                    style="font-size: 10px"><i class="fas fa-heart mr-1"></i> Add to
                                                    wish list </a>
                                            </div>
                                            <p class="mb-0"><span><strong>Price:
                                                        {{ $cartItem->product->price }}</strong></span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
